...
recipes.addShaped(<storagenetwork:remote>, [[<minecraft:emerald>, <thermalfoundation:storage_alloy:7>, <minecraft:emerald>],[<minecraft:nether_star>, <minecraft:iron_ingot>, <minecraft:nether_star>], [<minecraft:prismarine_shard>, <minecraft:structure_void>, <minecraft:prismarine_shard>]]);
